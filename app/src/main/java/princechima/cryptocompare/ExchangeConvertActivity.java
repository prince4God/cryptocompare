...
public class ExchangeConvertActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        moneyCodeView = findViewById(R.id.money_code_view);
        fullNameView = findViewById(R.id.full_name_view);
        btcValueEdit = findViewById(R.id.btc_value_edit);
        ethValueEdit = findViewById(R.id.eth_value_edit);
        flatValueEdit = findViewById(R.id.flat_value_edit);
        btcConvertButton = findViewById(R.id.btc_convert_button);
        ethConvertButton = findViewById(R.id.eth_convert_button);
        flatConvertButton = findViewById(R.id.flat_convert_button);
