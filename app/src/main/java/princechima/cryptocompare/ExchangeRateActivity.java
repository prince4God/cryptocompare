...
import princechima.cryptocompare.Model.GetRates;
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.currencyTextView = convertView.findViewById(R.id.currency_TextViewList);
                holder.btcTextView = convertView.findViewById(R.id.btc_getrateTextViewList);
                holder.ethTextView = convertView.findViewById(R.id.eth_getrateTextViewList);
